...
- **Расположение:** `C:\Users\NovikADMIN-Jun\Desktop\Development\TariffCalcBitrix24`
- **Git-ревизия:** `cb9c8b9` — `Add Bitrix locations pagination for sync and debug`
- **Статус рабочей копии на 03.08.2026:** без незакоммиченных изменений.
- **Стадия:** MVP калькулятора перевозок для Bitrix24. Локальные форма, API, PostgreSQL/Prisma, сохранение истории расчётов и базовая интеграция с вкладкой сделки уже реализованы. Реальные тарифы, OAuth Bitrix24, запись в поля сделки и экспорт файлов ещё не реализованы.
